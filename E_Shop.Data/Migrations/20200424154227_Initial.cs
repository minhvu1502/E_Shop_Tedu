        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Categories_Status_Enum_Constraint", "[Status] IN(0, 1)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Contacts_Status_Enum_Constraint", "[Status] IN(0, 1)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 4, 24, 22, 42, 27, 497, DateTimeKind.Local).AddTicks(3191)),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_Status_Enum_Constraint", "[Status] IN(0, 1, 2, 3, 4)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Promotions_Status_Enum_Constraint", "[Status] IN(0, 1)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Transactions_Status_Enum_Constraint", "[Status] IN(0, 1)");
                });
