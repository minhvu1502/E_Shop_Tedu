...
namespace E_Shop.Data.Migrations
{
    ...
    [Migration("20200426022501_SeedData")]
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Category", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Categories_Status_Enum_Constraint", "[Status] IN(0, 1)");
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Contact", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Contacts_Status_Enum_Constraint", "[Status] IN(0, 1)");
                });
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 4, 26, 9, 25, 0, 591, DateTimeKind.Local).AddTicks(1994));
                    ...
                    b.HasCheckConstraint("CK_Orders_Status_Enum_Constraint", "[Status] IN(0, 1, 2, 3, 4)");
                });
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2020, 4, 26, 9, 25, 0, 610, DateTimeKind.Local).AddTicks(4461),
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Promotion", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Promotions_Status_Enum_Constraint", "[Status] IN(0, 1)");
                });
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Transaction", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Transactions_Status_Enum_Constraint", "[Status] IN(0, 1)");
                });
